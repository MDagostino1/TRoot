...
Z  # ggsave(filename = paste0(out.path, name, ".svg"), 
...
# BUILD PLOT
# ================================================================================
make_reg_plot(data = xylem_n_cells_df, lm1 = xylem_n_cells_lm1, lm2 = xylem_n_cells_lm2, transition.age = 25, split = T, name = "xylem_n_cells")
```
